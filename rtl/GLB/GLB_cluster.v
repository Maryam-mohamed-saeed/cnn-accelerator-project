module GLB_CLUSTER#(
	...
	input		[WEIGHT_SIZE-1 : 0]			WEIGHT_data_in,

	// router 0 ports
	input									WEIGHT_data_out_ready_0,
	output	 								WEIGHT_data_out_valid_0,
	output	 	[WEIGHT_SIZE-1 : 0]			WEIGHT_data_out_0,
	// router 1 ports
	input									WEIGHT_data_out_ready_1,
	output	 								WEIGHT_data_out_valid_1,
	output	 	[WEIGHT_SIZE-1 : 0]			WEIGHT_data_out_1,
	// router 2 ports
	input									WEIGHT_data_out_ready_2,
	output	 								WEIGHT_data_out_valid_2,
	output	 	[WEIGHT_SIZE-1 : 0]			WEIGHT_data_out_2,
	
	// control signals
	input										WEIGHT_write_en, // enables write
	input		[WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]	WEIGHT_write_addr, // initial write address
	output	 									WEIGHT_write_done, // flags the end of write operation

	// router 0 controls
	input										WEIGHT_read_en_0, // enables read from port 0
	input		[WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]	WEIGHT_read_addr_0, // initial read address
	output	 									WEIGHT_read_done_0, // flags the end of read operation
	// router 1 controls
	input										WEIGHT_read_en_1, // enables read from port 1
	input		[WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]	WEIGHT_read_addr_1, // initial read address
	output	 									WEIGHT_read_done_1, // flags the end of read operation
	// router 2 controls
	input										WEIGHT_read_en_2, // enables read from port 2
	input		[WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]	WEIGHT_read_addr_2, // initial read address
	output	 									WEIGHT_read_done_2, // flags the end of read operation
...
weight_SRAM #(
	...
	// data signals
	.data_in_ready(WEIGHT_data_in_ready),
	.data_in_valid(WEIGHT_data_in_valid),
	.data_in(WEIGHT_data_in), // [WEIGHT_SIZE-1 : 0]

	// router 0 ports
	.data_out_ready_0(WEIGHT_data_out_ready_0),
	.data_out_valid_0(WEIGHT_data_out_valid_0),
	.data_out_0(WEIGHT_data_out_0), // [WEIGHT_SIZE-1 : 0]
	// router 1 ports
	.data_out_ready_1(WEIGHT_data_out_ready_1),
	.data_out_valid_1(WEIGHT_data_out_valid_1),
	.data_out_1(WEIGHT_data_out_1), // [WEIGHT_SIZE-1 : 0]
	// router 2 ports
	.data_out_ready_2(WEIGHT_data_out_ready_2),
	.data_out_valid_2(WEIGHT_data_out_valid_2),
	.data_out_2(WEIGHT_data_out_2), // [WEIGHT_SIZE-1 : 0]
	
	// control signals
	.write_en(WEIGHT_write_en), 
	.write_addr(WEIGHT_write_addr), // [WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]
	.write_done(WEIGHT_write_done), 

	// router 0 controls
	.read_en_0(WEIGHT_read_en_0), 
	.read_addr_0(WEIGHT_read_addr_0), // [WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]
	.read_done_0(WEIGHT_read_done_0), 
	// router 1 controls
	.read_en_1(WEIGHT_read_en_1), 
	.read_addr_1(WEIGHT_read_addr_1), // [WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]
	.read_done_1(WEIGHT_read_done_1),  
	// router 2 controls
	.read_en_2(WEIGHT_read_en_2), 
	.read_addr_2(WEIGHT_read_addr_2), // [WEIGHT_SRAM_ADDRESS_SIZE-1 : 0]
	.read_done_2(WEIGHT_read_done_2) 
);
