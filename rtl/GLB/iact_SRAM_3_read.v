/*
	input activations global buffer
	1 per cluster containing all needed iacts to finish 1 conv opertaion
	1 write port
	3 read ports; 1 for every iact router
	read operation:
...
reg [IACT_SRAM_ADDRESS_SIZE-1 : 0] write_address;

reg [IACT_SIZE-1 : 0] mem [0 : IACT_SRAM_DEPTH-1];
