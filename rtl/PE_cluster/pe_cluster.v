/* 
    FOR EVERY VARIABLE NAME, SOURCE IS ON THE LEFT, DESTINATION IS ON THE RIGHT 

    PE_cluster_controller tasks
        turn off not working PEs
        load weight spad (wait for load done)
        load iact spad (wait for load done)
        mac start to all working PEs 
        wait mac finish
        psum stream
        psum stream done
*/

/* psum_out output signal */
module PE_cluster #(
    parameter PE_NUM = 36,
    parameter ROW_NUM = 9,
...
// internal signals to track diagonal load done for iact, helps to start mac operation in PEs at right time
    ...
    // wire load_done_diagonal1 = (PE00_iact_load_done & PE30_iact_load_done & PE60_iact_load_done)? 1'b0 : 1'b1; 
    // wire load_done_diagonal2 = (PE01_iact_load_done & PE10_iact_load_done & PE31_iact_load_done 
    //                             & PE40_iact_load_done & PE61_iact_load_done & PE70_iact_load_done)? 1'b0 : 1'b1;
    // wire load_done_diagonal3 = (PE02_iact_load_done & PE11_iact_load_done & PE20_iact_load_done 
    //                             & PE32_iact_load_done & PE41_iact_load_done & PE50_iact_load_done 
    //                             & PE62_iact_load_done & PE71_iact_load_done & PE80_iact_load_done)? 1'b0 : 1'b1;
    // wire load_done_diagonal4 = (PE03_iact_load_done & PE12_iact_load_done & PE21_iact_load_done 
    //                             & PE33_iact_load_done & PE42_iact_load_done & PE51_iact_load_done 
    //                             & PE63_iact_load_done & PE72_iact_load_done & PE81_iact_load_done)? 1'b0 : 1'b1;
    // wire load_done_diagonal5 = (PE13_iact_load_done & PE22_iact_load_done & PE43_iact_load_done 
    //                             & PE52_iact_load_done & PE73_iact_load_done & PE82_iact_load_done)? 1'b0 : 1'b1;
...
always @(*) begin
    ...
    case (top_filter_mode)
    FILTER_3: begin 
        load_PEs_weight_done_top = PE00_weight_load_done & PE01_weight_load_done & PE02_weight_load_done & PE03_weight_load_done   // AND all 36 PEs weight load done
                                & PE10_weight_load_done & PE11_weight_load_done & PE12_weight_load_done & PE13_weight_load_done
                                & PE20_weight_load_done & PE21_weight_load_done & PE22_weight_load_done & PE23_weight_load_done
                                & PE30_weight_load_done & PE31_weight_load_done & PE32_weight_load_done & PE33_weight_load_done
                                & PE40_weight_load_done & PE41_weight_load_done & PE42_weight_load_done & PE43_weight_load_done
                                & PE50_weight_load_done & PE51_weight_load_done & PE52_weight_load_done & PE53_weight_load_done
                                & PE60_weight_load_done & PE61_weight_load_done & PE62_weight_load_done & PE63_weight_load_done
                                & PE70_weight_load_done & PE71_weight_load_done & PE72_weight_load_done & PE73_weight_load_done
                                & PE80_weight_load_done & PE81_weight_load_done & PE82_weight_load_done & PE83_weight_load_done; 

        // load_PEs_iact_done_top = PE00_iact_load_done & PE01_iact_load_done & PE02_iact_load_done & PE03_iact_load_done   // AND all 36 PEs iact load done
        //                         & PE10_iact_load_done & PE11_iact_load_done & PE12_iact_load_done & PE13_iact_load_done
        //                         & PE20_iact_load_done & PE21_iact_load_done & PE22_iact_load_done & PE23_iact_load_done
        //                         & PE30_iact_load_done & PE31_iact_load_done & PE32_iact_load_done & PE33_iact_load_done
        //                         & PE40_iact_load_done & PE41_iact_load_done & PE42_iact_load_done & PE43_iact_load_done
        //                         & PE50_iact_load_done & PE51_iact_load_done & PE52_iact_load_done & PE53_iact_load_done
        //                         & PE60_iact_load_done & PE61_iact_load_done & PE62_iact_load_done & PE63_iact_load_done
        //                         & PE70_iact_load_done & PE71_iact_load_done & PE72_iact_load_done & PE73_iact_load_done
        //                         & PE80_iact_load_done & PE81_iact_load_done & PE82_iact_load_done & PE83_iact_load_done; 
        ...
        // psum_stream_done_top = PE00_psum_stream_done & PE01_psum_stream_done & PE02_psum_stream_done & PE03_psum_stream_done  // AND all 36 PEs psum stream done
        //                         & PE10_psum_stream_done & PE11_psum_stream_done & PE12_psum_stream_done & PE13_psum_stream_done
        //                         & PE20_psum_stream_done & PE21_psum_stream_done & PE22_psum_stream_done & PE23_psum_stream_done
        //                         & PE30_psum_stream_done & PE31_psum_stream_done & PE32_psum_stream_done & PE33_psum_stream_done
        //                         & PE40_psum_stream_done & PE41_psum_stream_done & PE42_psum_stream_done & PE43_psum_stream_done
        //                         & PE50_psum_stream_done & PE51_psum_stream_done & PE52_psum_stream_done & PE53_psum_stream_done
        //                         & PE60_psum_stream_done & PE61_psum_stream_done & PE62_psum_stream_done & PE63_psum_stream_done
        //                         & PE70_psum_stream_done & PE71_psum_stream_done & PE72_psum_stream_done & PE73_psum_stream_done
        //                         & PE80_psum_stream_done & PE81_psum_stream_done & PE82_psum_stream_done & PE83_psum_stream_done;
        /////          CHECKKKKKKK    ///////////
        psum_stream_done_top = PE23_psum_stream_done & PE53_psum_stream_done & PE83_psum_stream_done;/////  CHECKKKKKKK
    end
    FILTER_5: begin 
        load_PEs_weight_done_top = PE00_weight_load_done & PE01_weight_load_done & PE02_weight_load_done & PE03_weight_load_done   // AND 20 PEs weight load done
                                & PE10_weight_load_done & PE11_weight_load_done & PE12_weight_load_done & PE13_weight_load_done
                                & PE20_weight_load_done & PE21_weight_load_done & PE22_weight_load_done & PE23_weight_load_done
                                & PE30_weight_load_done & PE31_weight_load_done & PE32_weight_load_done & PE33_weight_load_done
                                & PE40_weight_load_done & PE41_weight_load_done & PE42_weight_load_done & PE43_weight_load_done;
                                
        // load_PEs_iact_done_top = PE00_iact_load_done & PE01_iact_load_done & PE02_iact_load_done & PE03_iact_load_done   // AND all 20 PEs iact load done
        //                         & PE10_iact_load_done & PE11_iact_load_done & PE12_iact_load_done & PE13_iact_load_done
        //                         & PE20_iact_load_done & PE21_iact_load_done & PE22_iact_load_done & PE23_iact_load_done
        //                         & PE30_iact_load_done & PE31_iact_load_done & PE32_iact_load_done & PE33_iact_load_done
        //                         & PE40_iact_load_done & PE41_iact_load_done & PE42_iact_load_done & PE43_iact_load_done;
        ...
        // psum_stream_done_top = PE00_psum_stream_done & PE01_psum_stream_done & PE02_psum_stream_done & PE03_psum_stream_done  // AND all 20 PEs psum stream done
        //                         & PE10_psum_stream_done & PE11_psum_stream_done & PE12_psum_stream_done & PE13_psum_stream_done
        //                         & PE20_psum_stream_done & PE21_psum_stream_done & PE22_psum_stream_done & PE23_psum_stream_done
        //                         & PE30_psum_stream_done & PE31_psum_stream_done & PE32_psum_stream_done & PE33_psum_stream_done
        //                         & PE40_psum_stream_done & PE41_psum_stream_done & PE42_psum_stream_done & PE43_psum_stream_done;
    ...
    FILTER_7: begin 
        load_PEs_weight_done_top = PE00_weight_load_done & PE01_weight_load_done & PE02_weight_load_done & PE03_weight_load_done   // AND 28 PEs weight load done
                                & PE10_weight_load_done & PE11_weight_load_done & PE12_weight_load_done & PE13_weight_load_done
                                & PE20_weight_load_done & PE21_weight_load_done & PE22_weight_load_done & PE23_weight_load_done
                                & PE30_weight_load_done & PE31_weight_load_done & PE32_weight_load_done & PE33_weight_load_done
                                & PE40_weight_load_done & PE41_weight_load_done & PE42_weight_load_done & PE43_weight_load_done
        ...
        // load_PEs_iact_done_top = PE00_iact_load_done & PE01_iact_load_done & PE02_iact_load_done & PE03_iact_load_done   // AND 28 PEs iact load done
        //                         & PE10_iact_load_done & PE11_iact_load_done & PE12_iact_load_done & PE13_iact_load_done
        //                         & PE20_iact_load_done & PE21_iact_load_done & PE22_iact_load_done & PE23_iact_load_done
        //                         & PE30_iact_load_done & PE31_iact_load_done & PE32_iact_load_done & PE33_iact_load_done
        //                         & PE40_iact_load_done & PE41_iact_load_done & PE42_iact_load_done & PE43_iact_load_done
        ...
        // psum_stream_done_top = PE00_psum_stream_done & PE01_psum_stream_done & PE02_psum_stream_done & PE03_psum_stream_done  // AND 28 PEs psum stream done
        //                         & PE10_psum_stream_done & PE11_psum_stream_done & PE12_psum_stream_done & PE13_psum_stream_done
        //                         & PE20_psum_stream_done & PE21_psum_stream_done & PE22_psum_stream_done & PE23_psum_stream_done
        //                         & PE30_psum_stream_done & PE31_psum_stream_done & PE32_psum_stream_done & PE33_psum_stream_done
        //                         & PE40_psum_stream_done & PE41_psum_stream_done & PE42_psum_stream_done & PE43_psum_stream_done
...
always @(posedge clock) begin
    if (reset) begin
        ...
        if (PE70_psum_stream_done & PE71_psum_stream_done & PE72_psum_stream_done & PE73_psum_stream_done) begin
        // if (PE80_psum_stream_done & PE81_psum_stream_done & PE82_psum_stream_done & PE83_psum_stream_done) begin
